...
class Weights:
    ...
    def compute(self):
        ...
        if locked:
            warnings.warn(
                "Could not reuse weights '{self.filename}' in cache because a "
    ...
    def save_to_cache(self):
        ...
        if locked:
            warnings.warn(
                "Could not write weights to cache ('{self.filename}') because a "
...
class Grid:
    ...
    def to_netcdf(self, grid_format="CF", folder="./"):
        ...
        if not os.path.isfile(filename):
            ...
            if locked:
                warnings.warn(
                    "Could not write grid '{filename}' to cache because a lockfile of "
