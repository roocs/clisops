...
def test_xarray_da_mean_skipna_true():
    da = xr.DataArray(np.array([10., 10., 10., 10., 10., nan, nan, nan, nan, nan]))
...
def test_xarray_da_mean_keep_attrs_true():
    ds = xr.open_mfdataset('tests/mini-esgf-data/test_data/badc/cmip5/data/cmip5/output1/MOHC/HadGEM2-ES/rcp85/mon/'
                           'atmos/Amon/r1i1p1/latest/tas/*.nc', combine="by_coords", use_cftime=True)
